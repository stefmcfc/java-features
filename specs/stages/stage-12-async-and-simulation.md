...
- [ ] `STAGE-12-AC-01` [AUTO] — When the `HttpClient.sendAsync()` (11)
...
- [ ] `STAGE-12-AC-02` [AUTO] — When the `CompletableFuture` timeout
...
- [ ] `STAGE-12-AC-03` [AUTO] — When the `Future.state()` /
...
- [ ] `STAGE-12-AC-04` [AUTO] — When the `RandomGenerator` (17) example
...
- [ ] `STAGE-12-AC-07` [AUTO] — Where `seed` is omitted, the API shall
