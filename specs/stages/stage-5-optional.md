...
- [x] `STAGE-5-AC-01` [AUTO] — When the `Optional.or()` (9) example looks
...
- [x] `STAGE-5-AC-02` [AUTO] — When the `Optional.ifPresentOrElse()` (9)
...
- [x] `STAGE-5-AC-03` [AUTO] — When the `Optional.isEmpty()` (11) example
      queries a team with no players, it shall report `true`; for a
      populated team it shall report `false`.
- [x] `STAGE-5-AC-04` [AUTO] — When the `Optional.stream()` (9) example
...
- [x] `STAGE-5-AC-05b` [AUTO] — If an unknown team is requested, then the
