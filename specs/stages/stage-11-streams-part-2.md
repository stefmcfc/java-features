...
- [x] `STAGE-11-AC-01` [AUTO] — When the `Collectors.flatMapping()` (9)
...
- [x] `STAGE-11-AC-02` [AUTO] — When the `Collectors.filtering()` (9)
      ...
      position entirely.
- [x] `STAGE-11-AC-03` [AUTO] — When the `Collectors.toUnmodifiableSet()` /
...
- [x] `STAGE-11-AC-04` [AUTO] — When the `List.copyOf()` / `Map.copyOf()`
...
- [x] `STAGE-11-AC-05` [AUTO] — When the `Predicate.not()` (11) example
...
- [x] `STAGE-11-AC-06` [AUTO] — When the `LocalDate.datesUntil()` (9)
...
- [x] `STAGE-11-AC-07` [AUTO] — When `GET /api/streams/scorers-by-team` is
...
- [x] `STAGE-11-AC-09` [AUTO] — If `minGoals` is negative, then the API
